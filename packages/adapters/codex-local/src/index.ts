...
export const DEFAULT_CODEX_LOCAL_CHEAP_MODEL = "gpt-5.4-mini";
...
export const models = [
  ...
  { id: DEFAULT_CODEX_LOCAL_CHEAP_MODEL, label: DEFAULT_CODEX_LOCAL_CHEAP_MODEL },
...
export const modelProfiles: AdapterModelProfileDefinition[] = [
  {
    ...
    adapterConfig: {
      ...
      // Keep high effort so recovery/delegated work remains usable while staying on the mini lane.
...
- fastMode (boolean, optional): enable Codex Fast mode; supported on GPT-5.4, GPT-5.5, and passed through for manual model IDs
