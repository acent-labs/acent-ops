...
It expands the brief plugin notes in [docs/reference/SPEC.md](../SPEC.md) and should be read alongside the comparative analysis in [docs/reference/plugins/ideas-from-opencode.md](./ideas-from-opencode.md).

This is not part of the V1 implementation contract in [docs/reference/SPEC-implementation.md](../SPEC-implementation.md).
