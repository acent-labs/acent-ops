...
- `docs/reference/SPEC.md` gives the Board authority to set budgets, pause agents, pause work, and override any budget.
- `docs/reference/SPEC-implementation.md` says V1 must support monthly UTC budget windows, soft alerts, and hard auto-pause.
