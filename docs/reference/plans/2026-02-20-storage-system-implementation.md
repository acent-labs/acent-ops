...
- [ ] `docs/reference/CLI.md`: document `configure --section storage`.
- [ ] `docs/reference/DEVELOPING.md`: document default local storage path and overrides.
...
- [ ] `docs/reference/DATABASE.md` or `docs/reference/DEVELOPING.md`: mention storage backend behavior by deployment mode.
- [ ] `docs/reference/SPEC-implementation.md`: add storage subsystem and issue-attachment endpoint contract.
