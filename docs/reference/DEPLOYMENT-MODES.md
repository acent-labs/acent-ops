...
- implementation plan: `docs/reference/plans/deployment-auth-mode-consolidation.md`
- V1 contract: `docs/reference/SPEC-implementation.md`
- operator workflows: `docs/reference/DEVELOPING.md` and `docs/reference/CLI.md`
- invite/join state map: `docs/reference/spec/invite-flow.md`
