...
export const runTranscriptFixtureEntries: TranscriptEntry[] = [
  ...
  },
  {
    ...
    toolUseId: "item_1",
    input: {
      command: "sed -n '1,220p' docs/reference/GOAL.md",
  ...
  },
  {
    ...
    toolUseId: "item_2",
    input: {
      command: "sed -n '1,320p' docs/reference/SPEC-implementation.md",
      cwd: "/workspace/paperclip",
    },
  },
  {
    ...
    toolUseId: "item_1",
    content: "command: sed -n '1,220p' docs/reference/GOAL.md\nstatus: completed\nexit_code: 0\n\n# Paperclip\n\nPaperclip is the backbone of the autonomous economy.",
    isError: false,
  },
  {
    kind: "tool_result",
